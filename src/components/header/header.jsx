  ...
  return (
    <React.Fragment>
      <header className="header-area header-area-two">
        <div
          className={navBar ? "header-navigation sticky" : "header-navigation"}
          ref={headerNav}
        >
                    ...
                    <nav className={navBar ? "main-menu hide" : "main-menu"}>
                      <ul>
                        ...
                        <li className="menu-item has-children">
                          <a href="void(0)">Category</a>
                          <ul
                            className={
                              toggleCategoryNav ? "sub-menu open" : "sub-menu"
                            }
                          >
                            <li className="menu-item">
                              <NavLink
                            ...
                            <li className="menu-item">
                              <NavLink to="/stay-abode" onClick={onAnchorClick}>
                                StayAbode by Housr
                              </NavLink>
                            </li>
                          </ul>
                        ...
                        <li className="menu-item has-children">
                          <a href="void(0)">Locations</a>
                          <ul
                            className={
                              toggleLocationNav ? "sub-menu open" : "sub-menu"
                            }
                          >
                            <li className="menu-item">
                              <NavLink
                            ...
                            <li className="menu-item">
                              <NavLink to="/" onClick={onAnchorClick}>
                                Coming Soon
                              </NavLink>
                            </li>
                          </ul>
                  ...
                  <div className="header-right-nav">
                    <ul className="d-flex align-items-center">
                      <li className="hero-nav-btn">
                        <span className="main-btn">Request Call</span>
                      </li>
